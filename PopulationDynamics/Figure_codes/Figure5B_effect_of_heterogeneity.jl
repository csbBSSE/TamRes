...
het_0_pop_std = 0.434*std(het_0_pop)./het_0_pop_mean
het_0_pop_mean

#%%
#Het = 0.25 CASE
drug_status = 1
mean_dist1, std_dist1, mean_dist2, std_dist2, t_rate_12, t_rate_21, prol_rate, death_rate, current_score_of_cell = (-2, 0.25, 2, 0.25, 0, 0, 0.9, 0.1, pop_initial)
lock = Threads.SpinLock()
summary_stats_rep = []
Threads.@threads for rep in 1:num_replicates
    List_of_cells = init_double_gaussian(mean_dist1,std_dist1,mean_dist2,std_dist2,t_rate_12,t_rate_21,initial_cells,prol_rate,death_rate,current_score_of_cell)
...
het_25_pop_std = 0.434*std(het_25_pop)./het_25_pop_mean
het_25_pop_mean

#%%
#Het = 0.5 CASE
drug_status = 1
mean_dist1, std_dist1, mean_dist2, std_dist2, t_rate_12, t_rate_21, prol_rate, death_rate, current_score_of_cell = (-2, 0.5, 2, 0.5, 0, 0, 0.9, 0.1, pop_initial)
lock = Threads.SpinLock()
summary_stats_rep = []
Threads.@threads for rep in 1:num_replicates
    List_of_cells = init_double_gaussian(mean_dist1,std_dist1,mean_dist2,std_dist2,t_rate_12,t_rate_21,initial_cells,prol_rate,death_rate,current_score_of_cell)
...
het_50_pop_std = 0.434*std(het_50_pop)./het_50_pop_mean
het_50_pop_mean

#%%
#Het = 0.75 CASE
drug_status = 1
mean_dist1, std_dist1, mean_dist2, std_dist2, t_rate_12, t_rate_21, prol_rate, death_rate, current_score_of_cell = (-2, 0.75, 2, 0.75, 0, 0, 0.9, 0.1, pop_initial)
lock = Threads.SpinLock()
summary_stats_rep = []
Threads.@threads for rep in 1:num_replicates
    List_of_cells = init_double_gaussian(mean_dist1,std_dist1,mean_dist2,std_dist2,t_rate_12,t_rate_21,initial_cells,prol_rate,death_rate,current_score_of_cell)
...
het_75_pop_std = 0.434*std(het_75_pop)./het_75_pop_mean

#%%
#Het = 1 CASE
drug_status = 1
mean_dist1, std_dist1, mean_dist2, std_dist2, t_rate_12, t_rate_21, prol_rate, death_rate, current_score_of_cell = (-2, 1.0, 2, 1.0, 0, 0, 0.9, 0.1, pop_initial)
lock = Threads.SpinLock()
summary_stats_rep = []
Threads.@threads for rep in 1:num_replicates
    List_of_cells = init_double_gaussian(mean_dist1,std_dist1,mean_dist2,std_dist2,t_rate_12,t_rate_21,initial_cells,prol_rate,death_rate,current_score_of_cell)
...
het_1_pop_std = 0.434*std(het_1_pop)./het_1_pop_mean


#%%
plot(1:max_time,het_0_pop_mean.+1,ribbon=het_0_pop_std, yaxis=:log,fmt=:png,dpi =800,legend = false, grid = false)
plot!(1:max_time,het_25_pop_mean.+1,ribbon=het_25_pop_std, yaxis=:log,fmt=:png,dpi = 800,legend = false, grid = false)
plot!(1:max_time,het_50_pop_mean.+1,ribbon=het_50_pop_std, yaxis=:log,fmt=:png,dpi = 800,legend = false, grid = false)
plot!(1:max_time,het_75_pop_mean.+1,ribbon=het_75_pop_std, yaxis=:log,fmt=:png,dpi = 800,legend = false, grid = false)
plot!(1:max_time,het_1_pop_mean.+1,ribbon=het_1_pop_std, yaxis=:log,fmt=:png,dpi = 800,legend = false, grid = false)
ylims!((0.8,10^3))
xlims!((0,35))
savefig("Figure5B.png")
