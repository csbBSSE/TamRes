                            ...
                            deltaT = 0.1, tMax = 200, nInit = 100, parallel = T, workers = 1)
{
    ...
    Means <- c(3.99,-1.21,1.57, -0.86, -3.67)
    SDs <- c(3.05, 7.52, 5.21, 7.48, 9.20)
    names(Means) <- names(SDs) <- nodes
    ...
    dfTraj <- dfTraj %>% mutate(EMTScore = ZEB1 - MIR200, TamRes = ERa36 - ERa66)
